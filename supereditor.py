...
class Editor():
    ...
    def menu_bar(self):
        ...
        editmenu.add_command(label="Cut", command=lambda: functions.cut(self.editor))
        editmenu.add_command(label="Copy", command=lambda: functions.copy(self.editor))
        editmenu.add_command(label="Paste", command=lambda: functions.paste(self.editor))
        editmenu.add_command(label="Delete", command=lambda: functions.delete(self.editor))
        editmenu.add_separator()
        editmenu.add_command(label="Select All", command=lambda: functions.select_all(self.editor))
